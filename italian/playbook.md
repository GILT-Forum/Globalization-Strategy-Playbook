...
* **Concatenazione e variabili (segnaposto):** Consideriamo una frase come "Results 11&#126;20 of 136", posta all'inizio di una pagina in cui la vostra applicazione mostra i risultati di una query, 10 risultati alla volta. In giapponese, questa frase diventerebbe "結果136の&#126;20", e si nota subito che 136 viene prima di 11~20, contrariamente alla struttura inglese. 
