...
- [Chapter 4: Language Strategy](#chapter-4-language-strategy)
    ...
    - [The Relevance of Language Strategy](#TheRelevanceofLanguageStrategy)
    - [Partners and Audience for Language Strategy](#PartnersandAudienceforLanguageStrategy)
      - [Key Stakeholders](#KeyStakeholders)
      - [Drivers of Language Strategy](#DriversofLanguageStrategy)
    - [Building the Strategy](#BuildingtheStrategy)
    - [Components and Alignment](#ComponentsandAlignment)
    - [Governance: Best Practices for Language Strategy Oversight](#Governance:BestPracticesforLanguageStrategyOversight)
    - [Deeper Understanding of Language Strategy](#DeeperUnderstandingofLanguageStrategy)
      - [Spoken or Written](#SpokenorWritten)
      - [Linguistic and Cultural Considerations Impacting Localization](#LinguisticandCulturalConsiderationsImpactingLocalization)
    - [A Successful Language Strategy](#ASuccessfulLanguageStrategy)
- [Chapter 5: Technology Strategy](#Chapter5:TechnologyStrategy)
    - [What is a Globalization Technology Strategy?](#WhatisaGlobalizationTechnologyStrategy)
    - [Create and Implement Your Technology Strategy](#CreateandImplementYourTechnologyStrategy)
      - [Demonstrate Value](#DemonstrateValue)
      - [Map Business Objectives to Tools](#MapBusinessObjectivestoTools)
      - [Technology Maturity Model](#TechnologyMaturityModel)
      - [Understand Where You Sit in the Technology Maturity Model](#UnderstandWhereYouSitintheTechnologyMaturityModel)
      - [Identify What Technology to Go After](#IdentifyWhatTechnologytoGoAfter)
      - [Build a Business Case and Get Buy-In](#BuildaBusinessCaseandGetBuy-In)
      - [Implement the Solution](#ImplementtheSolution)
      - [Build Reporting and Monitor Results](#BuildReportingandMonitorResults)
    - [Technology Evolution](#TechnologyEvolution)
    - [How to Incorporate Different Technologies into Your Strategy](#HowtoIncorporateDifferentTechnologiesintoYourStrategy)
    - [Main takeaways](#Maintakeaways)
- [Chapter 6: Data Analytics for Globalization Strategy](#Chapter6:DataAnalyticsforGlobalizationStrategy)
    - [Globalization Data Strategy](#GlobalizationDataStrategy)
    - [Key Considerations](#KeyConsiderations)
    - [Strategy Reports and Dashboard](#StrategyReportsandDashboard)
    - [Understanding the Data](#UnderstandingtheData)
      - [Incomplete Data](#IncompleteData)
      - [Data Gaps](#DataGaps)
    - [Globalization Data Engineering and Analyst roles](#GlobalizationDataEngineeringandAnalystroles)
    - [Partnership](#Partnership)
    - [Analytics Tools](#AnalyticsTools)
    - [How to Build a Business Case](#HowtoBuildaBusinessCase)
      - [Using data to build a business case](#Usingdatatobuildabusinesscase)
    - [Measuring MT Quality and Effectiveness](#MeasuringMTQualityandEffectiveness)
    - [Main takeaways](#Maintakeaways-1)
- [Epilogue: Our Final Words](#Epilogue:OurFinalWords)
- [Appendix A: Technology Decision Drivers and Strategic Objectives](#AppendixA:TechnologyDecisionDriversandStrategicObjectives)
- [Appendix B: Data Inventory](#AppendixB:DataInventory)
